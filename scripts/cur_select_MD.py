...
"""
feature extraction and dimensionality reduction for molecular dynamics data
performing CUR matrix decomposition on molecular dynamics (MD) trajectory data 
analyzing atomic structures using symmetry functions
"""
